export default {
  ...
  footer: {
    ...
    internationalNumberValue: "+966 5X XXX XXXX",
    whatsapp: "Whatsapp",
    whatsappValue: "+201555778710",
    email: "Email",
    emailValue: "OMNEXA@gmail.com",
    headOffice: "Head office",
    headOfficeValue:
      "7th Floor – 1 Mostafa El Nahas Street – Intersection with Abbas El Akkad Street – Nasr City – Cairo – Egypt",
