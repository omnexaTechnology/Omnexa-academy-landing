    ...
    <header className="sticky top-0 z-50 w-full bg-white shadow-sm">
      <div className="flex items-center justify-between px-5 py-3 md:px-10 lg:px-20">
        ...
        <div className="flex flex-1 items-center gap-6 lg:gap-10">
          ...
          {/* Desktop Nav Links */}
          <nav className="hidden items-end gap-1 md:flex lg:gap-2">
            {NAV_LINKS.map(({ href, key, sectionId }) => {
              ...
              return (
                <a
                  ...
                  href={href}
                  className={[
                    "whitespace-nowrap pb-4 px-3 text-sm font-medium transition-colors lg:text-base xl:text-xl",
                    isActive
        ...
        <div className="hidden items-center gap-4 md:flex lg:gap-6 xl:gap-8">
          ...
          <div className="flex items-center gap-3 lg:gap-4 xl:gap-6">
            <a
              href={SIGNUP_URL}
              className="flex h-10 w-28 items-center justify-center rounded-full border-2 border-[#4C4BE0] text-sm font-normal text-[#4C4BE0] transition-colors hover:bg-[#4C4BE0]/5 lg:h-12 lg:w-32 lg:text-base xl:h-16 xl:w-[164px] xl:text-xl"
            >
              {t("signUp")}
            </a>
            <a
              href={SIGNIN_URL}
              className="flex h-10 items-center justify-center rounded-full bg-gradient-to-r from-[#0098DF] to-[#4C4BE0] px-5 text-sm font-semibold text-white transition-opacity hover:opacity-90 lg:h-12 lg:px-6 lg:text-base xl:h-16 xl:px-8 xl:text-xl"
            >
              {t("signIn")}
            </a>
          </div>
